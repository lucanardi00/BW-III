        ...
        <ListGroup>
          <ListGroup.Item className="p-3 border-0">
            <div className="d-flex justify-content-between">
              ...
              <span>
                <i className="bi bi-info-square-fill infoIcon"></i>
              </span>
            </div>
            <div>
          ...
          <ListGroup.Item className="item">
            <a href="">
              <div>
                ...
                <span className="text-secondary info">
                  1 giorno fa • 1.564 lettori
                </span>
              </div>
            </a>
          </ListGroup.Item>
          ...
          <ListGroup.Item className="item">
            <a href="">
              <div>
                <p className="fw-medium text-dark mb-1">
                  Scalapay e Deutsche Bank Uniscono I...
                </p>
                <span className="text-secondary info">
                  4 giorni fa • 840 lettori
                </span>
              </div>
            </a>
          </ListGroup.Item>
          <ListGroup.Item className="item">
            <a href="">
              <div>
                <p className="fw-medium text-dark mb-1">
                  Come nasce un punto vendita autom...
                </p>
                <span className="text-secondary info">
                  20 ore fa • 245 lettori
                </span>
              </div>
            </a>
          </ListGroup.Item>
      ...
      <Card className="mb-2">
        <Container className="p-2">
          ...
          <div className="text-center mb-3">
            <span className="text-secondary infoAd">
              Luca, reactivate your Premium free trial today!
            </span>
          </div>
          <div className="text-center mb-3">
            <img
            ...
            />
            <img
              src="https://media.licdn.com/dms/image/C560EAQEnfVYdDx5SNg/rightRail-logo-shrink_200_200/0/1650379295752?e=1716364800&v=beta&t=bmuSLHE4sylMasRLEIx6PiVSrEibrETYriZAOaja5Z4"
              alt=""
              style={{ width: "80px", height: "80px" }}
            />
          </div>
          ...
          <div className="text-center">
            <Button
              type="button"
              className="btn btn-primary bg-transparent text-primary fw-medium trial"
            >
              Reactivate Trial
            </Button>
          </div>
